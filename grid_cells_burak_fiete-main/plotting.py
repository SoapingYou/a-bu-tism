...
def compare_model_prediction(predicted_position_1, predicted_position_2, true_position, ax = None, box_width=None, 
                             show_limits = True, box_height=None, show=True, label_1="CAN", label_2="Baseline"):

    if ax is None:
        fig, ax = plt.subplots(figsize=(4, 4), dpi = 200)
    
    kw = {'c': 'black', 'ls': '-', 'lw':1.4, 'label':'Ground truth'}
    ...
    kw = {'c': 'red', 'ls': ':', 'lw':0.7, 'label':label_1}
    ax = plot_trajectory(*predicted_position_1.T, box_width = box_width, box_height = box_height,ax=ax, show=False, show_limits = False, plot_kwargs=kw)

    kw = {'c': 'blue', 'ls': ':', 'lw':0.7, 'label':label_2}
    ax = plot_trajectory(*predicted_position_2.T, box_width = box_width, box_height = box_height,ax=ax, show=False, show_limits = False, plot_kwargs=kw)
