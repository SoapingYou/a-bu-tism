...
def run_sim_three(sim=20000):
    ...
    return {
        "true_pos": np.array([base_model_i.og_position_x, base_model_i.og_position_y]).T,
        "can_sim_pos": can_result["pos"],
        "base_sim_pos": pos_pred_baseline}
